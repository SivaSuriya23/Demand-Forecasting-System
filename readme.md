...
\* Forecast \*\*expected units sold\*\* for a product
...
\* Lag features (`lag\_1`, `lag\_7`, `lag\_14`, `lag\_30`)

\* Rolling averages (`rolling\_mean\_7`, `rolling\_mean\_30`)
...
├── xgb\_demand\_model.pkl       # Trained XGBoost model

├── model\_features.pkl         # Feature schema used during training

├── label\_encoders.pkl         # Encoders for categorical variables
